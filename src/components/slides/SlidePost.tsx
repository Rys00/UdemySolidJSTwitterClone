...
const SlidePost: Component<Props> = (props) => {
  const slide = () => props.slide;
  const user = () => slide().user as User;
      ...
      <div class="flex-it flex-row">
        ...
        <article class="flex-it flex-grow flex-shrink cursor-pointer">
          ...
          <div class="flex-it flex-row flex-grow-0 items-center mb-2">
            <div class="flex-it mr-3 mb-3 w-full">{slide().content}</div>
          </div>
